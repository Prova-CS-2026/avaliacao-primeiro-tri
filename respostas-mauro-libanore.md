...
Aluno: Mauro Libanore

Matrícula: 20241PVAI10030011

Branch: avaliacao-mauro-libanore
...
```text
Resposta Questão 1: Um Processo de Desenvolvimento de Software é um conjunto de atividades, práticas, etapas e ferramentas utilizadas para planejar, criar, testar, implantar e manter um software.
```
---
...
```text
Resposta Questão 3: O Product Backlog é a lista completa de tudo o que é necessário para o produto como um todo, gerenciada pelo PO. Já o Sprint Backlog são os itens que a equipe selecionou para trabalhar durante a Sprint atual.
```
---
...
```text
Resposta Questão 5: 
- Épico: Uma funcionalidade grande que precisa ser dividida em partes para ser desenvolvida, ou seja a Funcionalidade em si.
- História de Usuário: Uma necessidade do usuário descrita.
- Tarefa: A atividade necessária para os desenvolvedores implementar.
```
---
...
```text
Resposta Questão 7: Uma branch é uma ramificação dentro do repositório. A finalidade é permitir que o desenvolvedor trabalhe de forma isolada, garantindo que o código principal não seja alterado ou quebrado durante o processo.
```
---
