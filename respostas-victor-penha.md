...
Aluno: Victor Penha Lopes de Oliveira

Matrícula:

Branch: avaliacao-victor-penha
...
```text
Resposta Questão 1: O processo de desenvolvimento de software é um processo de estruturação, escrita e preparação do tal
```
---
...
```text
Resposta Questão 5: O Épico é mais voltado ao negócio e dura mais tempo, podendo até mesmo ser meses, a história de usuário vem com a premissa de ser um "desejo" do usuário que devemos implementar, ele deve durar menos tempo do que o Épico, já que deve ser mais simples, isso enquanto a tarefa é apenas um dos itens requisitados neste 
```
---
...
```text
Resposta Questão 7: uma branch é uma ramificação da base, a sua finalidade é ser usado como o local de desenvolvimento do código para depois que for confirmado que ele está de acordo com o desejado ele seja fundido com a base
```
---
