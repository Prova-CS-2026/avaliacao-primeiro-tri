...
Aluno: Maria Eduarda Fiorenzano Bruning

Matrícula:

Branch: avaliacao-maria-bruning
...
```text
Resposta Questão 1: é um conjunto de atividades relacionadas que levam à produção de um software
```
---
...
```text
Resposta Questão 3: Product Backlog é a listagem de tudo que deve ser necessário no produto, nunca estando completo, já Sprint Backlog é a previsão de quais funcionalidades vão ser incrementadas na Sprint.
```
---
...
```text
Resposta Questão 5: História de Usuário  é uma funcionalidade específica do sistema do ponto de vista do cliente, Épico eé o conjunto dessas histórias. Tarefas são itens técnicos da história transformadas em um incremento do produto.
```
---
